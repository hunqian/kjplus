...
<html lang="en">
	<head>
		...
		<meta name="keywords" content="严重精神障碍患者随访服务记录表" />
		<meta name="description" content="严重精神障碍患者随访服务记录表" />
             ...
             <div class="tabbable"> 
              ...
              <div class="tab-content" style="width: 1000px;"> 
               <div id="followup" class="tab-pane in active"> 
                <div class="col-xs-12">
                	<span><font size="5" color="blue">严重精神障碍患者随访服务信息</font>                	
                	</span>
            	</div>
                <div class="center"> 
                 <div class="row text"> 
							         <div class="col-xs-2 coloradd"> 
					                  ...
					                  <div class="col-xs-4" style="padding-top: 1px;padding-bottom: 0px;"> 
					                   <span><input class="col-xs-12" type="text" placeholder="系统自动生成" readonly="readonly" style="border: none;height: 22px;" value ="<#if followCode??>${followCode!''}</#if>"/></span> 
										...
										<div class="col-xs-9">
											<span><input type="date"  id="cfgline_4_1"></span>
										</div>
										<div class="col-xs-1 coloradd">
											<span>死亡原因</span>
										</div>
										<div class="col-xs-9" style="text-align: initial;">
											<span class="editable display_4_2_1" style="width: 45%;" id="cfgline_4_2_1">躯体疾病</span>
											<span class="editable" style="width: 45%;display:none;" id="cfgline_4_2_2">传染病和寄生虫</span>
										</div>
										...
										<div class="col-xs-9">
											<span><input type="text" placeholder="请选择" id="cfgline_6"></span>
										</div>
										<div class="coloradd col-xs-3">
											<span>自知力</span>
										</div>
										...
										<div class="coloradd floatLeft hospital">
											<span>社会功能情况</span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>个人生活料理</span>
										...
										<div class="col-xs-7">
											<span class="editable" style="color: #000;" id="cfgline_10_1"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>家务劳动</span>
										</div>
										<div class="col-xs-7">
											<span class="editable" style="color: #000;" id="cfgline_10_2"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>生产劳动及工作</span>
										</div>
										<div class="col-xs-7">
											<span class="editable" style="color: #000;" id="cfgline_10_3"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>学习能力</span>
										</div>
										<div class="col-xs-7">
											<span class="editable" style="color: #000;" id="cfgline_10_4"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>社会人际交往</span>
										</div>
										<div class="col-xs-7">
											<span class="editable" style="color: #000;" id="cfgline_10_5"></span>
										</div>
										...
										<div class="col-xs-4 textInitial">
											<span>
												轻度滋事：<input type="text" placeholder="请填写" style="width:74%;" id="cfgline_11_1">次
											</span>	
										</div>
										<div class="col-xs-5 textInitial">
											<span>
												肇事：<input type="text" placeholder="请填写" style="width:80%;" id="cfgline_11_2">次
											</span>	
										</div>
										<div class="col-xs-4 textInitial">
											<span>
												肇祸：<input type="text" placeholder="请填写" style="width:80%;" id="cfgline_11_3">次
											</span>	
										</div>
										<div class="col-xs-5 textInitial">
											<span>
												其他危险行为：<input type="text" placeholder="请填写" style="width:67%;" id="cfgline_11_4">次
											</span>	
										</div>
										<div class="col-xs-4 textInitial">
											<span>
												自伤：<input type="text" placeholder="请填写" style="width:80%;" id="cfgline_11_5">次
											</span>	
										</div>
										<div class="col-xs-5 textInitial">
											<span>
												自杀未遂：<input type="text" placeholder="请填写" style="width:74%;" id="cfgline_11_6">次
											</span>	
										</div>
										<div class="col-xs-3 coloradd">
										...
										<div class="col-xs-5">
											<span><input type="text" placeholder="请选择" id="cfgline_13_1"></span>
										</div>
										<div class="col-xs-4">
											<span><input type="date" id="cfgline_13_2"></span>
										</div>
										<div class="col-xs-3 coloradd">
											<span>实验室检查</span>
										</div>
										...
										<div class="col-xs-9">
											<span class="editable" style="color: #000;" id="cfgline_15"></span>
										</div>
										<div class="col-xs-3 coloradd">
											<span>治疗效果</span>
										</div>
										<div class="col-xs-9">
											<span class="editable" style="color: #000;" id="cfgline_16"></span>
										</div>
										<div class="floatLeft coloradd" style="height: 80px;line-height: 40px;">
													...
													<div class="col-xs-2">
														<span>
															<input type="text" class="show_cfgline_18_1" placeholder="请选择" id="cfgline_18_1">
														</span>
													</div>
													<div class="coloradd col-xs-2">
														<span>机构及科别</span>
													...
													<div class="col-xs-3">
													<span><input type="text" class="input_18_1" placeholder="请选择是否转诊" id="cfgline_18_3" readonly='readonly'></span>
													</div>
													<div class="coloradd col-xs-2">
														<span>原因</span>
													</div>
													<div class="col-xs-7">
														<span><input type="text" class="input_18_1" placeholder="请选择是否转诊" id="cfgline_18_2" readonly='readonly'></span>
													</div>
										...
										<div class="col-xs-4">
											<span>
												药物1:<input type="text" placeholder="请输入" style="width: 80%;" id="cfgline_19_1_1">
											</span>
										</div>
										<div class="col-xs-3">
											<span>
												用法：每日（月）<input type="text" placeholder="请输入" style="width: 50%;" id="cfgline_19_1_2_1">次
											</span>
										</div>
										<div class="col-xs-2">
											<span>
												每次剂量<input type="text" placeholder="请输入" style="width: 30%;" id="cfgline_19_1_2_2">mg
											</span>
										</div>
										<div class="col-xs-4">
											<span>
												药物2:<input type="text" placeholder="请输入" style="width: 78%;" id="cfgline_19_2_1">
											</span>
										</div>
										<div class="col-xs-3">
											<span>
												用法：每日（月）<input type="text" placeholder="请输入" style="width: 50%;" id="cfgline_19_2_2_1">次
											</span>
										</div>
										<div class="col-xs-2">
											<span>
												每次剂量<input type="text" placeholder="请输入" style="width: 30%;" id="cfgline_19_2_2_2">mg
											</span>
										</div>
										<div class="col-xs-4">
											<span>
												药物3:<input type="text" placeholder="请输入" style="width: 78%;" id="cfgline_19_3_1">
											</span>
										</div>
										<div class="col-xs-3">
											<span>
												用法：每日（月）<input type="text" placeholder="请输入" style="width: 50%;" id="cfgline_19_3_2_1">次
											</span>
										</div>
										<div class="col-xs-2">
											<span>
												每次剂量<input type="text" placeholder="请输入" style="width: 30%;" id="cfgline_19_3_2_2">mg
											</span>
										</div>
										<div class="coloradd floatLeft treat">
											<span>用药指导</span>
										...
										<div class="col-xs-4">
											<span>
												药物1:<input type="text" placeholder="请输入" style="width: 80%;" id="cfgline_20_1_1">
											</span>
										</div>
										<div class="col-xs-3">
											<span>
												用法：每日（月）<input type="text" placeholder="请输入" style="width: 50%;" id="cfgline_20_1_2_1">次
											</span>
										</div>
										<div class="col-xs-2">
											<span>
												每次剂量<input type="text" placeholder="请输入" style="width: 30%;" id="cfgline_20_1_2_2">mg
											</span>
										</div>
										<div class="col-xs-4">
											<span>
												药物2:<input type="text" placeholder="请输入" style="width: 78%;" id="cfgline_20_2_1">
											</span>
										</div>
										<div class="col-xs-3">
											<span>
												用法：每日（月）<input type="text" placeholder="请输入" style="width: 50%;" id="cfgline_20_2_2_1">次
											</span>
										</div>
										<div class="col-xs-2">
											<span>
												每次剂量<input type="text" placeholder="请输入" style="width: 30%;" id="cfgline_20_2_2_2">mg
											</span>
										</div>
										<div class="col-xs-4">
											<span>
												药物3:<input type="text" placeholder="请输入" style="width: 78%;" id="cfgline_20_3_2">
											</span>
										</div>
										<div class="col-xs-3">
											<span>
												用法：每日（月）<input type="text" placeholder="请输入" style="width: 50%;" id="cfgline_20_3_2_1">次
											</span>
										</div>
										<div class="col-xs-2">
											<span>
												每次剂量<input type="text" placeholder="请输入" style="width: 30%;" id="cfgline_20_3_2_2">mg
											</span>
										</div>
										<div class="coloradd col-xs-3">
											<span>康复措施</span>
										...
										<div class="col-xs-9">
											<span><input type="text" class="show_cfgline_21" placeholder="请选择" id="cfgline_21"></span>
										</div>
										<div class="coloradd col-xs-3">
											<span>本次随访分类</span>
										</div>
										<div class="col-xs-9">
											<span class="editable" style="color: #000;" id="cfgline_22"></span>
										</div>
										<div class="coloradd col-xs-3">
											<span>下次随访日期</span>
										</div>
										<div class="col-xs-3">
											<span><input type="date" id="cfgline_23"></span>
										</div>
										<div class="coloradd col-xs-3">
											<span>随访医生签字</span>
										</div>
										<div class="col-xs-3">
											<select  class="doctor_24" id="cfgline_24" style="width: 140px">
										...
										<div class="btn" style="top:5px;" id="back-followup-btn">取消</div>
									              ...
									              <div style="display: none;" id="cover"></div> 
									               <!-- 转诊建议 --> 
										              <div class="adjective adjective_cfgline_18_1" id ="cfgline_18_1_dialog"> 
										               <p>转诊建议</p> 
										               	<div class = "show">
														</div>
														 <br /> 
										               	<input name="有" class="inputYes_18_1" type="text" value="" placeholder="请填写原因" style="display: none;border: none;border-bottom:black solid 1px;width:480px;"/>
										               <br /> 
										               	<input name="有" class="inputYes_18_1" type="text" value="" placeholder="请填写组织及科室" style="display: none;border: none;border-bottom:black solid 1px;width:480px;" />
										               <br /> 
										               <button class="adjectiveBut_cfgline_18_1">确定</button> 
										              </div> 
										              
										               <!-- 康复措施多选弹窗 -->
													<div class="adjective adjective_cfgline_21"  id ="cfgline_21_dialog">
														<p>康复措施</p>
															<div class = "show">
															</div>
														<br/>
														<button class="adjectiveBut_cfgline_21">确定</button>
													</div>
