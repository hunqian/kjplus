...
<html lang="en">
	<head>
		...
		<title>满月健康检查记录表</title>
		<meta name="keywords" content="满月健康检查记录表" />
		<meta name="description" content="满月健康检查记录表" />
		...
		.adjective, .expose, .disability, .family, .complexionUp, .familyMother, .familyBrothers, .familyChildren, .propose, .examine{
			...
			.symptom,.dangerous,.examine,.disability{
				width: 66rem;
				height: 19.75rem;
				display: none;
				border: 1px solid #ccc;
			...
			.editable-container{width:50% !important;}
		</style>
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-container-inner">
							...
							<div class="col-xs-12">
								...
								<div class="row">
											...
											<div class="tab-content" style="width: 1000px;">
												<div id="followup" class="tab-pane in active">
													<div class="center">
														<div class="row">
														<div class="col-xs-12">
                                                        	<span><font size="5" color="blue">满月健康检查信息</font>
                                                        	</span>
                                                    	</div>
                                                    	</div>
					                   ...
					                   <span><input class="col-xs-12" type="text" placeholder="系统自动生成" readonly="readonly" style="border: none;height: 22px;" value ="<#if followCode??>${followCode!''}</#if>"/></span> 
										...
										<div class="col-xs-9">
											<span><input type="text" placeholder="请输入" style="width: 40%;" id="cfgline_2_2">
												  <span class="editable" id="cfgline_2_1" style="width: 58%;color: #000;">
											</span>
										</div>
										<div class="col-xs-3 coloradd">
											<span>身长/cm</span>
										...
										<div class="col-xs-9">
											<span>
												...
												<span class="editable"	id="cfgline_3_1" style="width: 58%;color: #000;">
											</span>
										</div>
										<div class="col-xs-3 coloradd">
											<span>头围/cm</span>
									...
									<div class="row">
										...
										<div class="col-xs-9">
											<span class="editable" style="color: #000;" id="cfgline_5_1"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>皮肤</span>
										</div>
										<div class="col-xs-9">
											<span class="editable" style="color: #000;" id="cfgline_5_2"></span>
										</div>
										<div class="col-xs-2 coloradd" style="height: 80px;line-height: 80px;">
											<span>前囟</span>
										</div>
										<div class="col-xs-9">
											<span class="editable" style="color: #000;" id="cfgline_5_3_1"></span>
										</div>
										<div class="col-xs-9">
											<span>
												<input type="text" placeholder="请输入" style="width: 25%;" id="cfgline_5_3_2"><i>cm&times;</i>
												<input type="text" placeholder="请输入" style="width: 25%;" id="cfgline_5_3_3"><i>cm</i>	
											</span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>颈部包块</span>
										...
										<div class="col-xs-9">
											<span class="editable" style="color: #000;" id="cfgline_5_4"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>眼睛</span>
										</div>
										...
										<div class="col-xs-9">
											<span style="color: #000;" id="cfgline_5_7">—— ——</span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>口腔</span>
										</div>
										<div class="col-xs-9">
											<span class="editable" style="color: #000;" id="cfgline_5_8"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>胸部</span>
										</div>
										<div class="col-xs-9">
											<span class="editable" style="color: #000;" id="cfgline_5_9"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>腹部</span>
										</div>
										<div class="col-xs-9">
											<span class="editable" style="color: #000;" id="cfgline_5_10"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>脐部</span>
										</div>
										<div class="col-xs-9">
											<span class="editable"  style="color: #000;" id="cfgline_5_11"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>四肢</span>
										</div>
										<div class="col-xs-9">
											<span class="editable" style="color: #000;" id="cfgline_5_12"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>可疑佝偻病症状</span>
										</div>
										<div class="col-xs-9">
											<span style="color: #000;" id="cfgline_5_13">—— ——</span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>可疑佝偻病体征</span>
										</div>
										<div class="col-xs-9">
											<span style="color: #000;" id="cfgline_5_14">—— ——</span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>肛门/外生殖器</span>
										</div>
										<div class="col-xs-9">
											<span class="editable" style="color: #000;" id="cfgline_5_15"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>血红蛋白值</span>
										</div>
										<div class="col-xs-9">
											<span style="color: #000;" id="cfgline_5_16">—— ——</span>	
										</div>		
									</div>
									<div class="row">
										<div class="col-xs-3 coloradd">
										...
										<div class="col-xs-9">
											<span><input type="text" placeholder="请输入" id="cfgline_6"><em>小时/日</em></span>
										</div>
										<div class="col-xs-3 coloradd">
											<span>服用维生素D</span>
										</div>
										<div class="col-xs-9">
											<span><input type="text" placeholder="请输入" id="cfgline_7"><em>IU/日</em></span>
										</div>
										<div class="col-xs-3 coloradd">
											<span>发育评估</span>	
										</div>
										<div class="col-xs-9">
											<span style="color: #000;" id="cfgline_8">—— ——</span>	
										</div>	
										...
										<div class="col-xs-4 textInitial">
											<span id="cfgline_3_5">
												肺炎：<input type="text" placeholder="请填写" style="width:80%;" id="cfgline_9_1">次
											</span>	
										</div>
										<div class="col-xs-5 textInitial">
											<span id="cfgline_3_5">
												腹泻：<input type="text" placeholder="请填写" style="width:80%;" id="cfgline_9_2">次
											</span>	
										</div>
										<div class="col-xs-4 textInitial">
											<span id="cfgline_3_5">
												外伤：<input type="text" placeholder="请填写" style="width:80%;" id="cfgline_9_3">次
											</span>	
										</div>
										<div class="col-xs-5 textInitial">
											<span id="cfgline_3_5">
												其他：<input type="text" placeholder="请填写" style="width:80%;" id="cfgline_9_4">次
											</span>	
										</div>
										...
										<div class="col-xs-2">
											<span>
												<input type="text" class="show_cfgline_10_1" placeholder="请选择" id="cfgline_10_1">
											</span>
										</div>
										<div class="coloradd col-xs-2">
											<span>机构及科别</span>
										...
										<div class="col-xs-5">
										<span><input type="text" class="input_10_1" placeholder="请输入" id="cfgline_10_3" readonly='readonly'></span>
										</div>
										<div class="coloradd col-xs-2">
											<span>原因</span>
										</div>
										<div class="col-xs-9">
											<span><input type="text" class="input_10_1" placeholder="请输入" id="cfgline_10_2" readonly='readonly'></span>
										</div>
										<div class="col-xs-3 coloradd">
											<span>指导</span>
										</div>
										<div class="col-xs-9">
											<span><input type="text" class="show_cfgline_11" placeholder="请选择" id="cfgline_11"></span>
										</div>
										<div class="col-xs-3 coloradd">
											<span>下次随访日期</span>
										</div>
			...
			<!-- 转诊建议 --> 
              <div class="adjective adjective_cfgline_10_1" id ="cfgline_10_1_dialog"> 
               <p>转诊建议</p> 
               	<div class = "show" >
				</div>
				 <br /> 
               	<input name="有" class="inputYes_10_1" type="text" value="" placeholder="请填写原因" style="display: none;border: none;border-bottom:black solid 1px;width:480px;" id="cfgline_10_3"  />
               <br /> 
               	<input name="有" class="inputYes_10_1" type="text" value="" placeholder="请填写组织及科室" style="display: none;border: none;border-bottom:black solid 1px;width:480px;" id="cfgline_10_2"  />
               <br /> 
               <button class="adjectiveBut_cfgline_10_1">确定</button> 
              </div> 
		...
		<script type="text/javascript">			
			...
			jQuery(function($) {
				...
				$('.disabilityBut').click(function(){
					$.each($('.disability>input:checkbox:checked'),function(){
                    var obj = document.getElementsByName("disability");
    					var check_val = [];
    					for(k in obj){
        					if(obj[k].checked){
    				...
    				$('.disabled').attr('value',check_val);	
                    $('.disability').hide();
					$('#cover').hide();
            		});
				});
				$('#disabilityNo').click(function(){
					$(".disabilityYes").removeAttr("checked");
				});
				$('.disabilityYes').click(function(){
					$("#disabilityNo").removeAttr("checked");
				});
				
				//转诊建议
			    $('.proposef').click(function(){
					$('#cover').show();
					$('.examine').fadeIn("slow");
				});
				$('#cover').click(function(){
				...
				$('.examineYes').click(function(){
					$('.fil').fadeIn("slow");
				});
				$('.examineBtn').click(function(){
					$('.examine').hide();
					$('#cover').hide();
					var examine = $("input[name='examine']:checked").next("span").text();
					if(examine){
						$('.proposef').attr('value',examine);
					}else if(!examine){
						var inputVal = $("input:text[name='examineIpt']").val();
						$('.proposef').attr('value',"原因："+inputVal);
					}
				});
