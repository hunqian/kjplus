...
<div class="box">
    <!--header=========================================start-->
    <div class="header">
        <h1><i class="iconfont" onclick="javascript:history.back(-1);">&#xe61f;</i><span class="id_save" id="edit-docinfo-btn">编辑</span>档案详情</h1>
    </div>
    <!--header===========================================end-->
    ...
    <div class="main">
        ...
        <div class="data id_base_data">
            <div class="clearfix">
                ...
                <input type="text" placeholder="请输入" class="fr id_name" id="dataline_0" readonly="readonly">
            </div>
            <div class="clearfix ">
            ...
            <div class="clearfix">
                ...
                <input type="text" placeholder="未设置" class="fr " maxlength="18" id="dataline_2_1" readonly="readonly">
            </div>
            <div class="clearfix">
...
<script src="${base}/js/page_document_ftl.js"></script>

<script type="text/javascript">
		
		$(function() {
			PageDoc.init(${prsnCode});
		});
