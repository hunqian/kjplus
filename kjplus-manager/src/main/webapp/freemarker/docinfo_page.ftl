...
<html lang="en">
	<head>
		...
		<title>我的档案</title>
		<meta name="keywords" content="我的档案" />
		<meta name="description" content="我的档案" />
	...
	<div class="main-container" id="main-container">
									...
									<div class="col-xs-12">
										<div class="tabbable">
											<ul class="nav nav-tabs" id="myTab">
												<li <#if activepage = "" || activepage = "home">class="active"</#if>>
                                                    <a data-toggle="tab" href="#home">个人基本信息</a>
                                                </li>

                                                <li <#if activepage = "followup">class="active"</#if>>
                                                    <a data-toggle="tab" href="#followup">随访访视</a>
                                                </li >

                                                <li <#if activepage = "physical">class="active"</#if>>
                                                    <a data-toggle="tab" href="#physical">体检</a>
                                                </li>

                                                <li <#if activepage = "treatment">class="active"</#if>>
                                                    <a data-toggle="tab" href="#treatment">诊疗</a>
                                                </li>

                                                <li <#if activepage = "referral">class="active"</#if>>
                                                     <a data-toggle="tab" href="#referral">转诊</a>
                                                </li>

                                                <li <#if activepage = "exam">class="active"</#if>>
                                                    <a data-toggle="tab" href="#exam">测量记录</a>
                                                </li>

                                                <li <#if activepage = "consultation">class="active"</#if>>
                                                    <a data-toggle="tab" href="#consultation">咨询记录</a>
                                                </li>
											</ul>

											<div class="tab-content">
												<!-- 个人档案表 -->
												<div id="home" <#if activepage = "" || activepage = "home">class="tab-pane in active"<#else> class="tab-pane"</#if>>
													<div class="center">
														<div class="row">
														<div class="col-xs-12">
                                                    	...
                                                    	<div class="row text" style="text-align: initial;">
                                                    		...
                                                    		<div class="col-xs-3" style="padding-top: 1px;padding-bottom: 0px;">
                                                    			<span><input type="text" placeholder="系统自动生成" style="border: none;" value="<#if docInfo??>${docInfo.code!''}</#if>" ></span>
                                                    		</div>
                                                    		<div class="col-xs-2">
                                                    			<span>性别</span>
                                                    		</div>
                                                    		<div class="col-xs-3" style="padding-top: 1px;padding-bottom: 0px;height: 31px;">
                                                    			<span class="editable" id="cfgline_1_1" ></span>
                                                    		</div>
                                                    		<div class="col-xs-2">
                                                    			<span>出生日期</span>
                                                    		</div>
                                                    		...
                                                    		<div class="col-xs-3" style="padding-top: 1px;padding-bottom: 0px;height: 32px;">
                                                    			<span class="editable"	 style="color: #757575;"></span>
                                                    		</div>
                                                    		<div class="col-xs-2">
                                                    			<span>常住类型</span>
                                                    		</div>
												...
												<!-- 随访记录列表 -->	
												<div id="followup" <#if activepage = "followup">class="tab-pane in active"<#else> class="tab-pane"</#if>>
														<div class="table-responsive">
															<table id="followuplist-table" class="table table-striped table-bordered table-hover" style="width:100%">
																<thead>
																	<tr>
																		<th>ID</th>
																		<th>本次随访编码</th>
												...
												<!-- 体检记录列表 -->	
												<div id="physical" <#if activepage = "physical">class="tab-pane in active"<#else> class="tab-pane"</#if>>
														<div class="table-responsive">
															<table id="healthexamlist-table" class="table table-striped table-bordered table-hover" style="width:100%">
																<thead>
																	<tr>
									                                    <th>ID</th>
									                                    <th>编码</th>
												...
												<!-- 诊疗记录列表 -->	
												<div id="treatment" <#if activepage = "treatment">class="tab-pane in active"<#else> class="tab-pane"</#if>>
														<div class="table-responsive">
												...
												<!-- 转诊记录列表 -->	
												<div id="referral" <#if activepage = "referral">class="tab-pane in active"<#else> class="tab-pane"</#if>>
														<div class="table-responsive">
												...
												<!-- 测量记录列表 -->	
												<div id="exam" <#if activepage = "exam">class="tab-pane in active"<#else> class="tab-pane"</#if>>
														<div class="table-responsive">
															<table id="examlist-table" class="table table-striped table-bordered table-hover" style="width:100%">
												...
												<!-- 咨询记录列表 -->	
												<div id="consultation" <#if activepage = "consultation">class="tab-pane in active"<#else> class="tab-pane"</#if>>
														<div class="table-responsive">
		...
		<script src="${base}/js/docinfo_page.js"></script>
