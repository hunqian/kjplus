...
public class TestActivityEnrolService {
	...
	@Test
	public void testListActEnrolEbo() {
		try {
			int uid = 19;
			String  userType = "DOC";
			int mainId = 0;
			String mainType = "";
			String status = "";
			List<ActivityEnrolEbo> listActEnrol = activityEnrolService.listActEnrolEbo(uid, userType, mainId, mainType, status, 0, 10);
			for (ActivityEnrolEbo activityEnrolEbo : listActEnrol) {
				System.out.println(activityEnrolEbo);
			}
	...
	@Test
	public void testListActEnrolInnerDto() {
		try {
			int uid = 19;
			String  userType = "DOC";
			int mainId = 0;
			String mainType = "";
			String status = "";
			List<ActivityEnrolInnerDto> listActEnrol = activityEnrolService.listActEnrolInner(uid, userType, mainId, mainType, status, 0, 10);
			for (ActivityEnrolInnerDto activityEnrolEbo : listActEnrol) {
				System.out.println(activityEnrolEbo);
			}
