...
<head>
	...
	<meta charset="utf-8" />
	<title>微信用户列表</title>
	<meta name="courses" content="微信用户列表" />
	<meta name="description" content="微信用户列表" />
...
<body>
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-container-inner">
			...
			<div class="main-content">
				...
				<div class="page-content">
					<div class="table-header">微信用户列表</div>
		...
		<input type="hidden" id="th_wxuserface" value="">
			<dl>
	...
	<!--my javascript-->
	<script src="${base}/js/wxuser_list.js?v=1222"></script>
