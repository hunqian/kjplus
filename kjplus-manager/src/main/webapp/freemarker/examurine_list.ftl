...
<head>
	...
	<meta charset="utf-8" />
	<title>尿液测量列表</title>
	<meta name="courses" content="尿液测量列表" />
	<meta name="description" content="尿液测量列表" />
...
<body>
		...
		<div class="main-container-inner">
			...
			<div class="main-content">
				...
				<div class="page-content">
					<div class="table-header">尿液测量列表</div>
					<div class="table-responsive">
						<table id="examUrinelist-table"
				...
				<div class="page-content">
					<div class="table-header">尿检详情列表</div>
					<div class="table-responsive">
						<table id="urinedetails-table"
							class="table table-striped table-bordered table-hover"
							style="width:100%">
							<thead style="width:100%">
								<tr>
	...
	<div id="editDeptDialog" class="hide" style="width:400px">
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>尿检详情：</strong> <input type="text" placeholder="尿检详情"
						class="text" id="th_detail" maxlength="255" style="width: 300px;height:300px ">
					</select>
				</dd>
			</dl>
	</div>
	...
	<!--my javascript-->
	<script src="${base}/js/examurine_list.js"></script>
