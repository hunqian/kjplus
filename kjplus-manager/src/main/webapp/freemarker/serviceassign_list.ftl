...
<head>
	...
	<meta charset="utf-8" />
	<title>已签约列表</title>
	<meta name="courses" content="已签约列表" />
	<meta name="description" content="已签约列表" />
...
<body>
	...
	<!-- /.main-container -->
		...
		<div id="servAssAddDialog" class="hide" style="width:400px">
			...
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>居民服务包：</strong>
					<#-- 设置为多选   -->
					<select id="th_srvid" style="width: 160px"  multiple="multiple">
						<#list listSrvPackage as p>	
			...
			<dl>
				<dd class="clearfix" style="display: inline-block;" >
					...
					<input type="text" class="text" id="th_beginday" maxlength="255" style="width: 160px;" >
				</dd>
				<dd class="clearfix" style="display: inline-block;" >
					<strong>服务结束时间：</strong> 
					<input type="text" class="text" id="th_endday" maxlength="255" style="width: 160px;">
				</dd>
			</dl>
			<dl>
                <dd class="clearfix" style="display: inline-block;">
                    <strong>审核结果：</strong>
                    <select id="th_status2" style="width: 160px">
                        <option value ="">全部</option>
                        <option value ="R">拒签</option>
                        <option value ="Y">签约</option>
                    </select>
                </dd>
			</dl>
			<dl>
				<dd class="clearfix" style="display: inline-block;" >
					<strong>审核意见：</strong>
					 <textarea  id="th_memo2" cols="30" rows="5" class=""></textarea>
				</dd>
			</dl>
		</div>
		...
		<div id="servAssEditDialog" class="hide" style="width:400px">
			<dl>
                <dd class="clearfix" style="display: inline-block;">
					<strong>居民姓名：</strong>
					<select id="th_prsnid1" style="width: 160px" disabled="disabled">
						<option value ="0">全部</option>
					<#list doc as d>
						<option value ="${d.prsnId}">${d.prsnName}</option>
					</#list>
			...
			<dl>
                ...
                <dd class="clearfix" style="display: inline-block;" >
					<strong>团队：</strong>
					<select id="th_deptid1" style="width: 160px" disabled="disabled">
						<#list listDept as d>
							<option value ="${d.id}">${d.name}</option>
						</#list>
					</select>
				...
				<dd class="clearfix" style="display: inline-block;" >
					<strong>医生：</strong>
						<select id="th_stafid1" style="width: 160px" disabled="disabled">
                        	<#list listStaff as s>    
                            	<option value ="${s.stafId}">${s.stafName}</option>
                            </#list>	 
					</select>
			...
			<dl>
				<dd class="clearfix" style="display: inline-block;" >
					<strong>服务开始时间：</strong> 
					<input type="text" class="text" id="th_beginday1" maxlength="255" style="width: 160px;" disabled="disabled">
				</dd>
				<dd class="clearfix" style="display: inline-block;" >
					<strong>服务结束时间：</strong> 
					<input type="text" class="text" id="th_endday1" maxlength="255" style="width: 160px;">
				</dd>
			</dl>
			<dl>
                <dd class="clearfix" style="display: inline-block;">
                    <strong>审核结果：</strong>
                    <select id="th_status1" style="width: 160px">
                        <option value ="">全部</option>
                        <option value ="R">拒签</option>
                        <option value ="Y">签约</option>
                    </select>
			...
			<dl>
				<dd class="clearfix" style="display: inline-block;" >
					<strong>审核意见：</strong>
					 <textarea name="th_memo1" id="th_memo1" cols="30" rows="5" class=""></textarea>
				</dd>
			</dl>
		</div>
		...
		<div id="servStatusDialog" class="hide" style="width:400px">
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>审核意见：</strong> <textarea name="th_memo" id="th_memo" cols="30" rows="5" class=""></textarea>
				</dd>
			</dl>
			<dl>
                <dd class="clearfix" style="display: inline-block;">
	...
	<!--my javascript-->
	<script src="${base}/js/serviceassign_list.js"></script>
