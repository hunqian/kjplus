...
<head>
	...
	<meta charset="utf-8" />
	<title>血糖测量列表</title>
	<meta name="courses" content="血糖测量列表" />
	<meta name="description" content="血糖测量列表" />
...
<body>
		...
		<div class="main-container-inner">
			...
			<div class="main-content">
				...
				<div class="page-content">
					<div class="table-header">血糖测量列表</div>
					<div class="table-responsive">
						<table id="examglycemiclist-table"
	...
	<!--my javascript-->
	<script src="${base}/js/examglycemic_list.js"></script>
