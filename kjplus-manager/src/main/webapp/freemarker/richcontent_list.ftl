...
<body>
	...
	<div id="richContentAddDialog" class="hide" style="width:400px">
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>部门：</strong>
						<select id="th_adddeptid" style="width: 160px">
			...
			<dl>
				...
				<input type="hidden" id="th_imgfile1" value="">
				<input type="hidden" id="th_imgfile2" value="">
				<input type="hidden" id="th_imgfile3" value="">
				<input type="hidden" id="th_imgfile4" value="">
				<input type="hidden" id="th_imgfile5" value="">
			<dl>
				
					<strong>头像上传：</strong>
					<dd class="clearfix" style="display: inline-block;"> 
					<form method="POST" id="form_imgfile1">
					<input type="file" name="imgfile" id="imgfile1"/>
					</form>
					</dd>
					<dd class="clearfix" style="display: inline-block;">
					<form method="POST" id="form_imgfile2">
					<input type="file" name="imgfile" id="imgfile2"/>
					</form>
					</dd>
					<dd class="clearfix" style="display: inline-block;">
					<form method="POST" id="form_imgfile3">
					<input type="file" name="imgfile" id="imgfile3"/>
					</form>
					</dd>
					<dd class="clearfix" style="display: inline-block;">
					<form method="POST" id="form_imgfile4">
					<input type="file" name="imgfile" id="imgfile4"/>
					</form>
					</dd>
					<dd class="clearfix" style="display: inline-block;">
					<form method="POST" id="form_imgfile5">
		...
		<div id="richContentEditDialog" class="hide" style="width:400px">
			<dl>
				...
				<input type="hidden" id="th_imgfile6" value="">
				<input type="hidden" id="th_imgfile7" value="">
				<input type="hidden" id="th_imgfile8" value="">
				<input type="hidden" id="th_imgfile9" value="">
				<input type="hidden" id="th_imgfile10" value="">
			<dl>
				
					<strong>头像上传：</strong>
					<dd class="clearfix" style="display: inline-block;">
					<form method="POST" id="form_imgfile6">
					<input type="file" name="imgfile" id="imgfile6"/>
					</form>
					</dd>
					<dd class="clearfix" style="display: inline-block;">
					<form method="POST" id="form_imgfile7">
					<input type="file" name="imgfile" id="imgfile7"/>
					</form>
					</dd>
					<dd class="clearfix" style="display: inline-block;">
					<form method="POST" id="form_imgfile8">
					<input type="file" name="imgfile" id="imgfile8"/>
					</form>
					</dd>
					<dd class="clearfix" style="display: inline-block;">
					<form method="POST" id="form_imgfile9">
					<input type="file" name="imgfile" id="imgfile9"/>
					</form>
					</dd>
					<dd class="clearfix" style="display: inline-block;">
					<form method="POST" id="form_imgfile10"> 
	...
	<!--my javascript-->
	<script src="${base}/js/richContent_list.js?v=1222"></script>
