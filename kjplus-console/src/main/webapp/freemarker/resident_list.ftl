...
<head>
    ...
    <!--my-class-->
    <link href="./css/resident_list.css" rel="stylesheet">
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered bulk_action my_table">
                                    ...
                                    <tr>
                                        ...
                                        <td>67</td>
                                        <td class="my_label">
                                            <span class="green">高血压</span>
                                            <span class="orange">糖尿病</span>
                                            <span class="blue">肺结核</span>
                                            <span class="green">精神病</span>
                                            <span class="orange">老年痴呆症</span>
                                            <!--<span>...</span>-->
                                        </td>
                                        <td>110250888888888888</td>
                                        <td>15910771011</td>
                                        <td>上地中关村创业大厦</td>
                                        <td>王东医生团队/未签约</td>
                                        <td>查看</td>
...
<!--my javascript-->
<script src="./js/resident_list.js"></script>
