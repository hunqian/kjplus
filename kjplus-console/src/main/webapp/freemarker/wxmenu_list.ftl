...
<head>
	...
	<meta charset="utf-8" />
	<title>菜单列表</title>
	<meta name="courses" content="菜单列表" />
...
<body>
   ...
   <!-- 添加父类menu  -->
	<div id="menuListAddDialog" class="hide" style="width:400px">
				<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>公众号：</strong>
						<select id="th_laccid" name="th_laccid" style="width:120px;">";
							<option value="0">公众号</option>
							<#list accs as a>
								<option value="${a.accid}">${a.account}</option>
							</#list>
						</select>
				</dd>
			</dl>
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>name：</strong> <input type="text" placeholder="请输入name"
						class="text" id="th_lname" maxlength="255" style="width: 160px;">
				</dd>
				<dd class="clearfix" style="display: inline-block;">
					<strong>url：</strong> <input type="text" placeholder="请输入url"
						class="text" id="th_lurl" maxlength="255" style="width: 160px;">
				</dd>
			</dl>
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>key：</strong> <input type="text" placeholder="请输入key"
						class="text" id="th_lkey" maxlength="255" style="width: 160px;">
				</dd>
				<dd class="clearfix" style="display: inline-block;">
						<strong>type：</strong>
						<select id="th_ltype" name="th_ltype" style="width:120px;">";
			...
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>note：</strong> <input type="text" placeholder="请输入note"
						class="text" id="th_lnote" maxlength="255" style="width: 160px;">
				</dd>
				<dd class="clearfix" style="display: inline-block;">
					<strong>orderSeq：</strong> <input type="text" placeholder="请输入orderSeq"
						class="text" id="th_lorderSeq" maxlength="255" style="width: 160px;">
				</dd>
			</dl>
		</div>
	
	<!-- 添加子类menu  -->
	<div id="menuAddDialog" class="hide" style="width:400px">
		<input type="hidden" name="th_code" id="th_code">
			<dl>
				...
				<dd class="clearfix" style="display: inline-block;">
					<strong>url：</strong> <input type="text" placeholder="请输入url"
						class="text" id="th_url" maxlength="255" style="width: 160px;">
				</dd>
			</dl>
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>key：</strong> <input type="text" placeholder="请输入key"
						class="text" id="th_key" maxlength="255" style="width: 160px;">
				</dd>
				<dd class="clearfix" style="display: inline-block;">
						<strong>type：</strong>
						<select id="th_type" name="th_type" style="width:120px;">";
							<option value="">未设置</option>
							<option value="click">点击</option>
							<option value="view">视图</option>
						</select>
			...
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>note：</strong> <input type="text" placeholder="请输入note"
						class="text" id="th_note" maxlength="255" style="width: 160px;">
				</dd>
				<dd class="clearfix" style="display: inline-block;">
					<strong>orderSeq：</strong> <input type="text" placeholder="请输入orderSeq"
						class="text" id="th_orderSeq" maxlength="255" style="width: 160px;">
				</dd>
			</dl>
		</div>
	...
	<!-- 修改menu  -->
	<div id="menuUpdateDialog" class="hide" style="width:400px">
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>name：</strong> <input type="text" placeholder="请输入name"
				...
				<dd class="clearfix" style="display: inline-block;">
					<strong>url：</strong> <input type="text" placeholder="请输入url"
						class="text" id="th_uurl" maxlength="255" style="width: 160px;">
					</select>
				</dd>
			</dl>
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>key：</strong> <input type="text" placeholder="请输入key"
						class="text" id="th_ukey" maxlength="255" style="width: 160px;">
					</select>
				</dd>
				<dd class="clearfix" style="display: inline-block;">
					<strong>note：</strong> <input type="text" placeholder="请输入note"
						class="text" id="th_unote" maxlength="255" style="width: 160px;">
					</select>
				</dd>
			</dl>
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>orderSeq：</strong> <input type="text" placeholder="请输入orderSeq"
						class="text" id="th_uorderSeq" maxlength="255" style="width: 160px;">
					</select>
				</dd>
			</dl>
		</div>
	...
	<!--my javascript-->
	<script src="${base}/js/wxmenu_list.js"></script>
