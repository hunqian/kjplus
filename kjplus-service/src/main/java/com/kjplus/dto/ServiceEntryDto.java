...
public class ServiceEntryDto implements Serializable {
	...
	private List<ServiceEntryDto> subs = new ArrayList<ServiceEntryDto>();
	...
	public List<ServiceEntryDto> getSubs() {
		return subs;
	}

	public void setSubs(List<ServiceEntryDto> subs) {
		this.subs = subs;
	}
	...
	public String toString() {
		return "ServiceEntryDto [id=" + id + ", pid=" + pid + ", srvType=" + srvType + ", srvCode=" + srvCode + ", srvName=" + srvName + ", srvTypeId="
				+ srvTypeId + ", srvTypeCode=" + srvTypeCode + ", srvTypeName=" + srvTypeName + ", srvMemo=" + srvMemo + ", flag=" + flag + ", createTime="
				+ createTime + ", orgCode=" + orgCode + ", orgName=" + orgName + ", MainId=" + MainId + ", MainType=" + MainType + ", acceptorPoint="
