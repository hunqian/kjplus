...
public class MblCalEntryDto {
	...
	private List<MblCalInfoDto> listCalInfo = new ArrayList<MblCalInfoDto>();

	public MblCalEntryDto() {
		super();
	}
	...
	public List<MblCalInfoDto> getListCalInfo() {
		return listCalInfo;
	}

	public void setListCalInfo(List<MblCalInfoDto> listCalInfo) {
