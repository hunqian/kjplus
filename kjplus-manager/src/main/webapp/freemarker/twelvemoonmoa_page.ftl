...
<html lang="en">
	<head>
		...
		<title>12月龄儿童健康检查记录表</title>
		<meta name="keywords" content="12月龄儿童健康检查记录表" />
		<meta name="description" content="12月龄儿童健康检查记录表" />
							...
							<div class="col-xs-12">
								...
								<div class="row">
											...
											<div class="tab-content" style="width: 1000px;">
												<div id="followup" class="tab-pane in active">
													<div class="center">
														<div class="row">
														<div class="col-xs-12">
                                                        	<span><font size="5" color="blue">12月龄健康检查信息</font>
                                                        	</span>
                                                    	</div>
                                                    	</div>
                                       ...
                                       <div class="col-xs-3 coloradd">
										...
										<div class="col-xs-9">
											<span><input type="text" placeholder="请输入" style="width: 40%;" id="cfgline_2_2">
												  <span class="editable" id="cfgline_2_1" style="width:58%;color: #000;"></span>
											</span>
										</div>
										<div class="col-xs-3 coloradd">
											<span>身长（高）/cm</span>
										...
										<div class="col-xs-9">
											<span>
												...
												<span class="editable" id="cfgline_3_1" style="width:58%;color: #000;"></span>
											</span>
										</div>
									</div>
									<div class="row">
										...
										<div class="col-xs-9">
											<span class="editable" style="color: #000;" id="cfgline_4_1"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>皮肤</span>
										</div>
										<div class="col-xs-9">
											<span class="editable" style="color: #000;" id="cfgline_4_2"></span>
										</div>
										<div class="col-xs-2 coloradd" style="height: 80px;line-height: 80px;">
											<span>前囟</span>
										</div>
										<div class="col-xs-9">
											<span class="editable" style="color: #000;" id="cfgline_4_3_1"></span>
										</div>
										<div class="col-xs-9">
											<span>
												<input type="text" placeholder="请输入" style="width: 25%;" id="cfgline_4_3_2"><i>cm&times;</i>
												<input type="text" placeholder="请输入" style="width: 25%;" id="cfgline_4_3_3"><i>cm</i>	
											</span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>眼睛</span>
										...
										<div class="col-xs-9">
											<span class="editable" style="color: #000;" id="cfgline_4_4"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>耳外观</span>
										</div>
										<div class="col-xs-9">
											<span class="editable" style="color: #000;" id="cfgline_4_5"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>听力</span>
										</div>
										<div class="col-xs-9">
											<span class="editable" style="color: #000;" id="cfgline_4_6"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>出牙/龋齿（颗）</span>
										</div>
										<div class="col-xs-9">
											<span>
												<input type="text" placeholder="请输入" style="width: 40%;" id="cfgline_4_7_1"><i>/</i>
												<input type="text" placeholder="请输入" style="width: 40%;" id="cfgline_4_7_2">
											</span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>胸部</span>
										...
										<div class="col-xs-9">
											<span class="editable" style="color: #000;" id="cfgline_4_8"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>腹部</span>
										</div>
										<div class="col-xs-9">
											<span class="editable" style="color: #000;" id="cfgline_4_9"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>四肢</span>
										</div>
										<div class="col-xs-9">
											<span class="editable" style="color: #000;" id="cfgline_4_10"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>步态</span>
										</div>
										...
										<div class="col-xs-9">
											<span class="editable" style="color: #000;" id="cfgline_4_12">
										</div>
										<div class="col-xs-2 coloradd">
											<span>血红蛋白值</span>
										</div>
									...
									<div class="row">
										...
										<div class="col-xs-9">
											<span><input type="text" placeholder="请输入" id="cfgline_5"><em>小时/日</em></span>
										</div>
										<div class="col-xs-3 coloradd">
											<span>服用维生素D</span>
										</div>
										<div class="col-xs-9">
											<span><input type="text" placeholder="请输入" id="cfgline_6"><em>IU/日</em></span>
										</div>
										<div class="col-xs-3 coloradd">
											<span>发育评估</span>	
										</div>
										...
										<div class="col-xs-5 textInitial">
											<span id="cfgline_3_5">
												其他：<input type="text" placeholder="请填写" style="width:80%;" id="cfgline_8_4">次
											</span>	
										</div>
			...
			<!-- 转诊建议 --> 
              <div class="adjective adjective_cfgline_9_1" id ="cfgline_9_1_dialog"> 
               <p>转诊建议</p> 
				 ...
				 <br /> 
               	<input name="有" class="inputYes_9_1" type="text" value="" placeholder="请填写原因" style="display: none;border: none;border-bottom:black solid 1px;width:480px;" id="cfgline_9_2"  />
               <br /> 
               	<input name="有" class="inputYes_9_1" type="text" value="" placeholder="请填写组织及科室" style="display: none;border: none;border-bottom:black solid 1px;width:480px;" id="cfgline_9_3"  />
               <br /> 
