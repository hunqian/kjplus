                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <table id="infolist-table" class="table table-striped table-bordered bulk_action my_table">
                                    <thead>
                                    <tr>
...
<!--my javascript-->
<script src="${base}/js/info_list.js"></script>
