	...
	initTable:function(){
		oUserTable = $('#userlist-table').DataTable({
			...
			"columnDefs" :[
				{
				    ...
				    "render": function(data, type, row) {
				    	var html = "";
				    	html += '<button class="btn btn-xs btn-danger" id="uploadImage'+ data[0] + '"><i class="icon-cogs bigger-120">上传头像</i></button>';
						return html;
				    }
				}
			],
			...
			"aoColumns": [
						...
						{ "sName": "有效结束", "bSortable": false, "bVisible": true},
			...
			"fnInitComplete": function() {
				...
				var condition = "";
				condition += "<label>昵称:<input type=\"text\" placeholder=\"请输入昵称\" id=\"user_nickname1\" /></label>";
