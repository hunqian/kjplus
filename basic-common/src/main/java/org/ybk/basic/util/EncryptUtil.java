...
public class EncryptUtil {
	...
	public static String defautlKey = "LmMGStGtOpF4xNyvYt54EQ==";

	public static String encrypt(String xmlStr, String myKey) {
	...
	public static String encrypt(String xmlStr) {
		return encrypt(xmlStr, EncryptUtil.defautlKey);
	}

	public static String decrypt(String xmlStr, String myKey) throws Exception {
	...
	public static String decrypt(String xmlStr) throws Exception {
		return decrypt(xmlStr, defautlKey);
	}
