...
<head>
	...
	<meta charset="utf-8" />
	<title>随访详情列表</title>
	<meta name="courses" content="随访详情列表" />
	<meta name="description" content="随访详情列表" />
...
<body>
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-container-inner">
			...
			<div class="main-content">
				...
				<input type="hidden" id="prsnName" value="<#if prsnName??>${prsnName!''}</#if>">
				<div class="page-content">
					<div class="table-header">随访详情列表</div>
					<div class="table-responsive">
						<table id="followuppage-table"
	...
	<!--my javascript-->
	<script src="${base}/js/followuppage_list.js"></script>
