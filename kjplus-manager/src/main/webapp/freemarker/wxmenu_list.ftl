	...
	<div class="main-container" id="main-container">
		...
		<div class="main-container-inner">
			...
			<div class="main-content">
				...
				<div class="table-header">菜单子列表列表</div>
   ...
   <!-- 添加父类menu  -->
	<div id="menuListAddDialog" class="hide" style="width:400px">
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>名称：</strong> <input type="text" placeholder="请输入"
						class="text" id="th_lname" maxlength="255" style="width: 160px;">
				</dd>
			</dl>
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>路径：</strong> <input type="text" placeholder="请输入"
						class="text" id="th_lurl" maxlength="255" style="width: 160px;">
				</dd>
			</dl>
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>key：</strong> <input type="text" placeholder="请输入"
			...
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>类型：</strong>
						<select id="th_ltype" name="th_ltype" style="width:160px;">";
			...
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>备注：</strong> <input type="text" placeholder="请输入"
						class="text" id="th_lnote" maxlength="255" style="width: 160px;">
				</dd>
			</dl>
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>序号：</strong> <input type="text" placeholder="请输入"
	...
	<div id="menuAddDialog" class="hide" style="width:400px">
		<input type="hidden" name="th_code" id="th_code">
			...
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>备注：</strong> <input type="text" placeholder="请输入note"
