...
//        document.getElementById("entry").addEventListener("click",shu);
//        function shu(){
//        	console.log("点击按钮发送事件已被监听");
//        }
    },
    initChatContacts:function () {
    	...
    	$.ajax({
			url: base + '/mgr_getchatslistjson.html',
			data: reqData,
			type: 'GET',
			dataType: 'json',
	...
	rebindEvent:function(){
		...
		$("[id^='listcontact_']").unbind().click(function (){
				var id = $(this).attr('id');
...
$('.webq ul>li').click(function (){
	...
	var html1 = '<img style="display: inline;vertical-align: middle;width:20px;" src="'+src+'" title="'+title+'"/>';
