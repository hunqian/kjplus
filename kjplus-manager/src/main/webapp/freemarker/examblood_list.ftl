...
<head>
	...
	<meta charset="utf-8" />
	<title>血压测量列表</title>
	<meta name="courses" content="血压测量列表" />
	<meta name="description" content="血压测量列表" />
...
<body>
		...
		<div class="main-container-inner">
			...
			<div class="main-content">
				...
				<div class="page-content">
					<div class="table-header">血压测量列表</div>
					<div class="table-responsive">
						<table id="exambloodlist-table"
	...
	<!--my javascript-->
	<script src="${base}/js/examblood_list.js"></script>
