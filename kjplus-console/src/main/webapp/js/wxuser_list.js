...
WxUser = {
	...
	initTable:function(){
		oWxUserTable = $('#wxuserlist-table').DataTable({
			...
			"aoColumns": [
						...
						{ "sName": "上级id", "bSortable": false, "bVisible": true},
						{ "sName": "上级昵称", "bSortable": false, "bVisible": true},
						...
						{ "sName": "上传头像", "bSortable": false, "bVisible": true},						
				],
			"fnInitComplete": function() {
				...
				condition += "<label>组织：<select id=\"qh_orgid\" name=\"qh_orgid\" style=\"width:100px;\">";
	...
	rebindEvent:function(){
		$("[id^='uploadface']").unbind().click(function(){
			var uid = $(this).attr("id").substring("uploadface".length);
			WxUser.editWxUserDialog(uid);
		});	
	},
