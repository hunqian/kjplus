...
<head>
	...
	<meta charset="utf-8" />
	<title>设备列表</title>
	<meta name="courses" content="设备列表" />
...
<body>
	...
	<!-- 添加dvcparam -->	
	<div id="addDvcParamDialog" class="hide" style="width:400px">
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>设备类型：</strong>
						<select id="th_dvctype" name="th_ltype" style="width:120px;">";
							<option value="M">手机</option>
							<option value="I">IPAD</option>
							<option value="S">血糖仪</option>
							<option value="P">血压仪</option>
						</select>
				</dd>
				<dd class="clearfix" style="display: inline-block;">
						<strong>参数类型：</strong>
						<select id="th_paramtype" name="th_ltype" style="width:120px;">";
			...
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>设备参数：</strong> <input type="text" placeholder="请输入参数"
						class="text" id="th_dvcparam" maxlength="255" style="width: 160px;">
					</select>
				</dd>
			</dl>
		</div>
	...
	<!--my javascript-->
	<script src="${base}/js/dvcparam_list.js"></script>
