...
<head>
	...
	<meta charset="utf-8" />
	<title>参照列表</title>
	<meta name="courses" content="参照列表" />
	<meta name="description" content="参照列表" />
...
<body>
		...
		<div class="main-container-inner">
			...
			<div class="main-content">
				...
				<div class="page-content">
					<div class="table-header">参照类型列表</div>
					<div class="table-responsive">
						<table id="reftype-table"
				...
				<div class="page-content">
					<div class="table-header">参照值列表</div>
					<div class="table-responsive">
						<table id="refvalue-table"
							class="table table-striped table-bordered table-hover"
							style="width:100%">
							<thead style="width:100%">
								<tr>
	...
	<div id="orgAddDialog" class="hide" style="width:400px">
		<input type="hidden" name="th_code" id="th_code">
			<dl>
				...
				<dd class="clearfix" style="display: inline-block;">
					<strong>别称：</strong> <input type="text" placeholder="请输入别称"
	...
	<!--my javascript-->
	<script src="${base}/js/ref_list.js"></script>
