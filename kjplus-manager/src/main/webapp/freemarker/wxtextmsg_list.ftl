...
<head>
	...
	<meta charset="utf-8" />
	<title>消息文本列表</title>
	<meta name="courses" content="消息文本列表" />
	<meta name="description" content="消息文本列表" />
...
<body>
		...
		<div class="main-container-inner">
			...
			<div class="main-content">
				...
				<div class="page-content">
					<div class="table-header">消息文本列表</div>
					<div class="table-responsive">
						<table id="wxtextmsglist-table"
	...
	<!--my javascript-->
	<script src="${base}/js/wxtextmsg_list.js"></script>
