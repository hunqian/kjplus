<#assign user = Session["KJCONSOLE_SESS"]>
					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="${user.faceUrl!base+'/assets/avatars/user.jpg'}" alt="Jason's Photo" />
							...
							<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								...
								<li>
									<a href="${base}/logout.html" title="退出">
										<i class="icon-off"></i>
										退出
									</a>
								</li>
