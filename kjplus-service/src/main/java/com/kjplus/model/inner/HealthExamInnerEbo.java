...
public class HealthExamInnerEbo implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1079922070429700295L;
	...
	public HealthExamInnerEbo() {
		super();
	}

	public HealthExamInnerEbo(int id, String code, int prsnId, String prsnName, int staffId, String staffName, int orgId, String orgName, int tbcfgId, double temperature, int respiratoryFrequency,
	...
	public String toString() {
		return "HealthExamInnerEbo [id=" + id + ", code=" + code + ", prsnId=" + prsnId + ", prsnName=" + prsnName + ", staffId=" + staffId + ", staffName=" + staffName + ", orgId=" + orgId
				+ ", orgName=" + orgName + ", tbcfgId=" + tbcfgId + ", temperature=" + temperature + ", respiratoryFrequency=" + respiratoryFrequency + ", pulseRate=" + pulseRate
				+ ", leftHightBlood=" + leftHightBlood + ", leftLowBlood=" + leftLowBlood + ", rightHightBlood=" + rightHightBlood + ", rightLowBlood=" + rightLowBlood + ", height=" + height
				+ ", weight=" + weight + ", theWaist=" + theWaist + ", bodyMassIndex=" + bodyMassIndex + ", flag=" + flag + ", createTime=" + createTime + ", healthMemo=" + healthMemo + "]";
	}
