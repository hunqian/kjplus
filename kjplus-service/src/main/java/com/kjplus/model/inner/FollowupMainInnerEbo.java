...
public class FollowupMainInnerEbo implements java.io.Serializable {
	...
	public String toString() {
		return "FollowupMainInnerEbo [id=" + id + ", code=" + code + ", selfCode=" + selfCode + ", prsnId=" + prsnId + ", stafffId=" + stafffId
				+ ", orgId=" + orgId + ", tbcfgId=" + tbcfgId + ", flpeMiscType=" + flpeMiscType + ", flpeTypeId=" + flpeTypeId + ", flpeTime=" + flpeTime
				...
				+ tabDataId + ", resRefName=" + resRefName + ", inspectRefName=" + inspectRefName + "]";
	}
