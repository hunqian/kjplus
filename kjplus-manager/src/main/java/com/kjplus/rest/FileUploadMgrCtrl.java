...
@Controller
// 文件上传控制器类
public class FileUploadMgrCtrl implements ServletContextAware { // 实现ServletContextAware接口，获取本地路径

	@SuppressWarnings("unused")
	private static final int BUFFER_SIZE = 10 * 1024;

	private static Logger logger = Logger.getLogger(FileUploadMgrCtrl.class);
