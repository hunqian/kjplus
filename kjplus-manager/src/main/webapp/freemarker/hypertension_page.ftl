...
<html lang="en">
	<head>
		...
		<meta name="keywords" content="高血压患者随访服务记录表" />
		<meta name="description" content="高血压患者随访服务记录表" />
             ...
             <div class="tabbable"> 
              ...
              <div class="tab-content" style="width: 1000px;"> 
               <div id="followup" class="tab-pane in active"> 
                <div class="col-xs-12">
                	<span><font size="5" color="blue">高血压患者随访信息</font>
                	</span>
            	</div>
                <div class="center"> 
                 <div class="row text"> 
					                   ...
					                   <span><input class="col-xs-12" type="text" placeholder="系统自动生成" readonly="readonly" style="border: none;height: 22px;" value ="<#if followCode??>${followCode!''}</#if>"/></span> 
										...
										<div class="col-xs-9">
											<span style="text-align: initial;">
												<i>其他：</i>
												<input type="text" placeholder="请输入" style="width: 90%;" id="cfgline_3_1">
											</span>
										</div>
										...
										<div class="col-xs-9">
											<span><input type="text" placeholder="请输入" id="cfgline_4_5"></span>
										</div>
										...
										<div class="col-xs-9">
											<span>
												...
												<input type="text" placeholder="请输入" style="width: 40%;" id="cfgline_5_1_2">
											</span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>日饮酒量（两）</span>
										...
										<div class="col-xs-9">
											<span>
												...
												<input type="text" placeholder="请输入" style="width: 40%;" id="cfgline_5_2_2">
											</span>
										</div>
										...
										<div class="col-xs-9">
											<span><input type="text" placeholder="请输入" id="cfgline_10_1"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>用法用量</span>
										</div>
										<div class="col-xs-9">
											<span>
												每日<input type="text" placeholder="请输入" style="width: 10%" id="cfgline_10_2_1">次
												每次<input type="text" placeholder="请输入" style="width: 40%" id="cfgline_10_2_2">
											</span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>药物名称2</span>
										...
										<div class="col-xs-9">
											<span><input type="text" placeholder="请输入" id="cfgline_10_3"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>用法用量</span>
										</div>
										<div class="col-xs-9">
											<span>
												每日<input type="text" placeholder="请输入" style="width: 10%" id="cfgline_10_4_1">次
												每次<input type="text" placeholder="请输入" style="width: 40%" id="cfgline_10_4_2">
											</span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>药物名称3</span>
										...
										<div class="col-xs-9">
											<span><input type="text" placeholder="请输入" id="cfgline_10_5"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>用法用量</span>
										</div>
										<div class="col-xs-9">
											<span>
												每日<input type="text" placeholder="请输入" style="width: 10%" id="cfgline_10_6_1">次
												每次<input type="text" placeholder="请输入" style="width: 40%" id="cfgline_10_6_2">
											</span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>其他药物</span>
										...
										<div class="col-xs-9">
											<span><input type="text" placeholder="请输入" id="cfgline_10_7"></span>
										</div>
										<div class="col-xs-2 coloradd">
											<span>用法用量</span>
										</div>
										<div class="col-xs-9">
											<span>
												每日<input type="text" placeholder="请输入" style="width: 10%" id="cfgline_10_8_1">次
												每次<input type="text" placeholder="请输入" style="width: 40%" id="cfgline_10_8_2">
											</span>
										</div>
										...
										<div class="col-xs-2">
											<span>
												<input type="text" class="show_cfgline_11" placeholder="请选择" id="cfgline_11">
											</span>
										</div>
										<div class="coloradd col-xs-2">
											<span>机构及科别</span>
										...
										<div class="col-xs-5">
										<span><input type="text" class="input_11" placeholder="请输入" id="cfgline_11_2" readonly='readonly'></span>
										</div>
										<div class="coloradd col-xs-2">
											<span>原因</span>
										</div>
										<div class="col-xs-9">
											<span><input type="text" class="input_11" placeholder="请输入" id="cfgline_11_1" readonly='readonly'></span>
										</div>
										<div class="col-xs-3 coloradd">
											<span>下次随访日期</span>
										</div>
										...
										<div class="col-xs-9">
											<select class="doctor_13" id="cfgline_13" style="width: 160px">
      ...
      <!-- 覆盖层 --> 
              ...
              <div class="adjective adjective_cfgline_11" id ="cfgline_11_dialog"> 
               <p>转诊建议</p> 
				 ...
				 <br /> 
               	<input name="有" class="inputYes_11" type="text" value="" placeholder="请输入" style="display: none;border: none;border-bottom:black solid 1px;width:480px;" />
               <br /> 
               	<input name="有" class="inputYes_11" type="text" value="" placeholder="请输入" style="display: none;border: none;border-bottom:black solid 1px;width:480px;" />
               <br /> 
