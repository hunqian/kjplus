...
<head>
	...
	<meta charset="utf-8" />
	<title>管理员列表</title>
	<meta name="courses" content="管理员列表" />
...
<body>
	...
	<!-- 修改adminUser  -->
	<div id="adminUserUpdateDialog" class="hide">
	<input type="hidden" id="th_uface" value="">
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>用户名：</strong> <input type="text" placeholder="请输入"
						class="text" id="th_uusername" maxlength="255" style="width: 160px;">
					</select>
				</dd>
				<dd class="clearfix" style="display: inline-block;">
					<strong>密码：</strong> <input type="text" placeholder="请输入"
			...
			<dl>
				<dd class="clearfix" style="display: inline-block;">
					<strong>邮箱：</strong> <input type="text" placeholder="请输入"
						class="text" id="th_uemail" maxlength="255" style="width: 160px;">
					</select>
				</dd>
				<dd class="clearfix" style="display: inline-block;">
					<strong>电话号码：</strong> <input type="text" placeholder="请输入"
			...
			<dl>
				...
				<dd class="clearfix" style="display: inline-block;">
					<strong>昵称：</strong> <input type="text" placeholder="请输入"
	...
	<!--my javascript-->
		<script src="${base}/js/adminuser_list.js?v=1222"></script>
